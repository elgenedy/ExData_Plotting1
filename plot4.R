...
## top left
with(tabFiltered, plot(datetime,Global_active_power,  type = "l", xlab="", ylab="Global Active Power (kilowatts)"))
...
##top right
with(tabFiltered, plot(datetime,Voltage,  type = "l"))

##down right
with(tabFiltered, plot(datetime,Global_reactive_power,  type = "l"))
